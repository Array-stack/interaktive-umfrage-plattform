            ...
            <div className="text-neutral mb-8">
              <div className="bg-white p-6 rounded-lg shadow-md border border-neutral-light/50 mb-6 transform transition-all duration-300 hover:shadow-lg">
                <h3 className="text-xl font-bold mb-4 text-primary flex items-center">
                  ...
                  <span className={`flex-grow ${i18n.language === 'ar' ? 'text-right' : 'text-left'}`}>{t('about_what_is_title')}</span>
                </h3>
                <p className={`text-base leading-relaxed ${i18n.language === 'ar' ? 'pl-9 text-right' : 'pr-9 text-left'}`} dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-md border border-neutral-light/50 transform transition-all duration-300 hover:shadow-lg hover:border-primary/20">
                  <h3 className="text-xl font-bold mb-4 text-primary flex items-center">
                    ...
                    <span className={`flex-grow ${i18n.language === 'ar' ? 'text-right' : 'text-left'}`}>
                  ...
                  <ul className={`space-y-3 ${i18n.language === 'ar' ? 'pl-9 text-right' : 'pr-9 text-left'}`} dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
                    {[
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-neutral-light/50 transform transition-all duration-300 hover:shadow-lg hover:border-primary/20">
                  ...
                  <p className={`hidden md:block mb-3 ${i18n.language === 'ar' ? 'pl-9 text-right' : 'pr-9 text-left'}`} dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>{t('about_areas_desktop')}</p>
                  <p className={`md:hidden mb-3 ${i18n.language === 'ar' ? 'pl-9 text-right' : 'pr-9 text-left'}`} dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>{t('about_areas_mobile')}</p>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-neutral-light/50 mt-8 transform transition-all duration-300 hover:shadow-lg hover:border-primary/20">
                ...
                <ul className={`space-y-3 grid md:grid-cols-3 ${i18n.language === 'ar' ? 'pl-9 text-right' : 'pr-9 text-left'}`} dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
                  {[
